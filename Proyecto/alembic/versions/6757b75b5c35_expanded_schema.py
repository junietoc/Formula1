...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('extra_tiempo', 'reserva', 'otro', name='privilegetypeenum'), nullable=True),
    ...
    sa.Column('status', sa.Enum('activa', 'cumplida', 'cancelada', 'expirada', name='reservationstatusenum'), nullable=True),
    sa.ForeignKeyConstraint(['bike_id'], ['bicycles.id'], ),
    sa.ForeignKeyConstraint(['station_id'], ['stations.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('bike_id', sa.UUID(), nullable=True),
    sa.Column('reporter_id', sa.UUID(), nullable=True),
    sa.Column('type', sa.Enum('accidente', 'deterioro', 'uso_indebido', 'otro', name='incidenttypeenum'), nullable=True),
    ...
    sa.Column('status', sa.Enum('activa', 'expirada', 'apelada', name='sanctionstatusenum'), nullable=True),
    ...
    op.alter_column('bicycles', 'id',
               existing_type=sa.NUMERIC(),
               type_=sa.UUID(),
               existing_nullable=False)
    op.create_index('ix_bicycles_current_station_id', 'bicycles', ['current_station_id'], unique=False)
    ...
    op.alter_column('loans', 'user_id',
               ...
               type_=sa.UUID(),
               existing_nullable=False)
    op.alter_column('loans', 'bike_id',
               existing_type=sa.NUMERIC(),
               type_=sa.UUID(),
               existing_nullable=False)
    op.alter_column('loans', 'station_out_id',
               existing_type=sa.NUMERIC(),
               type_=sa.UUID(),
               existing_nullable=False)
    op.alter_column('loans', 'station_in_id',
               existing_type=sa.NUMERIC(),
               type_=sa.UUID(),
    ...
    op.alter_column('stations', 'id',
               ...
               type_=sa.UUID(),
               existing_nullable=False)
    op.add_column('users', sa.Column('privilege', sa.Enum('extra_tiempo', 'reserva', 'otro', name='privilegetypeenum'), nullable=True))
